...
abstract class Data {
	...
	private function defineDefaultExemplar() 
    {
		$exemplar = [];
	...
	private function defineValuesTypes() 
    {
		$types = [];
	...
	private function defineEditableFields() 
    {
		$editable_fields = [];	
	...
	private function defineDeletedMarkerColumn() 
    {
	...
	private function definePrimaryField() 
    {		
		foreach ($this->fields as $name=>$field) {
	...
	private function defineDateFields() 
    {		
		foreach ($this->fields as $name=>$field) {
	...
	private function getOne($primary) 
    {
	...
	private function getAll($criterion=null) 
    {
